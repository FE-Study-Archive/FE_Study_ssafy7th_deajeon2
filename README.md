...
```
[ 김지영 ]
- 달성 목표 : Vue 배운 내용 복습 및 정리
- 달성 현황 :

[ 박승훈 ]
- 달성 목표 : React 프로젝트 기능 개선 및 확장
- 달성 현황 : 메뉴 삭제 기능 구현, useNavigate를 활용한 라우트 이동 적용

[ 박재경 ]
- 달성 목표 : css layout 강의 수강	
- 달성 현황 : 그리드 레이아웃 학습 

[ 박재현 ]
- 달성 목표 : React 복습
- 달성 현황 : Vue project를 위한 준비, ERD, 와이어프레임 작성
